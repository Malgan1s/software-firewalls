...
## Содержание
- [Установка Glasswire](#1-установка-glasswire)
- [Изучение и описание настроек межсетевого экрана](#2-изучение-и-описание-настроек-межсетевого-экрана)
  - [Основный вид брандмауэра "GlassWire защита"](#21-основный-вид-брандмауэра-glasswire-защита)
  - [Монитор трафика](#22-монитор-трафика)
  - [Сетевое сканирование](#23-сетевое-сканирование)
  - [Платные функции безопасности](#24-платные-функции-безопасности)
- [Создание сетевых соединений](#3-создание-сетевых-соединений)
  - [Создание подключения по FTP с помощью FileZilla](#31-создание-подключения-по-ftp-с-помощью-filezilla)
- [Способы блокировки сетевых соединений](#4-способы-блокировки-сетевых-соединений)
  - [Блокировка трафика для приложений](#41-блокировка-трафика-для-приложений)
  - [Блокировка соединений](#42-блокировка-соединений)
    - [Блокировка подключения по протоколу FTP](#421-блокировка-подключения-по-протоколу-ftp)
    - [Блокировка подключения по протоколу RDP](#422-блокировка-подключения-по-протоколу-rdp)
- [Сканирование виртуальной машины с помощью nmap](#5-сканирование-виртуальной-машины-с-помощью-nmap)
- [Реализация соединений на Python](#6-реализация-соединений-на-python)
