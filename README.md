...
- [Антивирусные средства](#антивирусные-средства)
  - [1. Устанавливаем Glasswire](#1-устанавливаем-glasswire)
  - [2. Изучаем и подробно описываем настройки межсетевого экрана](#2-изучаем-и-подробно-описываем-настройки-межсетевого-экрана)
    - [2.1 Основной вид брандмауэра GlassWire защита](#21-основной-вид-брандмауэра-glasswire-защита)
  ...
  - [3. Создаём не менее трёх сетевых соединений](#3-создаём-не-менее-трёх-сетевых-соединений)
    - [3.1 Подключение по FTP с помощью FileZilla](#31-подключение-по-ftp-с-помощью-filezilla)
  - [4. Способы блокировки сетевых соединений](#4-способы-блокировки-сетевых-соединений)
    ...
    - [4.2 Блокировка соединений из задания 3](#42-блокировка-соединений-из-задания-3)
      - [4.2.1 Блокировка FTP по порту 21](#421-блокировка-ftp-по-порту-21)
      - [4.2.2 Блокировка RDP](#422-блокировка-rdp)
